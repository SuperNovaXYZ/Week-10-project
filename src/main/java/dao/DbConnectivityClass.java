...
public class DbConnectivityClass {
    final static String DB_NAME="CSC311_BD_TEMP";
        ...
        final static String SQL_SERVER_URL = "jdbc:mysql://csc311project.mariadb.database.azure.com/";//update this server name
        final static String DB_URL = "jdbc:mysql://csc311project.mariadb.database.azure.com/"+DB_NAME;//update this database name
        final static String USERNAME = "csc311admin@csc311project";// update this username
        final static String PASSWORD = "farmingdale123!";// update this password
